      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed left-0 shadow-4xl right-0 top-[5rem] p-3 pt-0 bg-gray-800 border-b border-b-white/20"
          >
...
export default NewHomeHamburger;